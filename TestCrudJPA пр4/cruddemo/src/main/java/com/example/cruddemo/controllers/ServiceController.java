...
public class ServiceController {
    ...
    @Autowired
    public ServiceController(ServiceRepository serviceRepository, ManufacturerRepository manufacturerRepository, CarModelRepository carModelRepository, CarBrendRepository carBrendRepository, TypeofCarRepository typeofCarRepository, CarCategoryRepository carcategoryRepository, ExecutionStageRepository executionStageRepository, ProductRepository productRepository, TechnicalpassportRepository technicalpassportRepository, CarRepository carRepository, OrdersRepository ordersRepository, PasportRepository pasportRepository, PersonRepository personRepository) {
    ...
    public String dan(Model model){
        ...
        model.addAttribute("pasports", pasportRepository.findAll());
